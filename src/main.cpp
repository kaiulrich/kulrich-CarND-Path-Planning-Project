...
int main() {
  ...
  // my_lane: Line the car is. starting with 1 (middle line)
  int my_lane = 1;
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
			...
			***************************************************************************/
            	...
            	bool other_car_righ = false;
            	for ( int i = 0; i < sensor_fusion.size(); i++ ) {
                	float d = sensor_fusion[i][6];
                	int other_car_lane = -1;
                	// where is car number i 
                	if ( d > 0 && d < 4 ) {
                  		other_car_lane = 0;
                	} else if ( d > 4 && d < 8 ) {
                  		other_car_lane = 1;
				...
				// dirty data no acurat lene found
                	if (other_car_lane < 0) {				
                  		continue;
                	}
			...
			***************************************************************************/
	          ...
	          if ( other_car_ahead ) { // other Car ahead
